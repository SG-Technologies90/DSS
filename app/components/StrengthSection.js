...
return ( <section className="py-16 md:py-24 bg-gray-100"> <style>
{`         @keyframes dashMove {
  ...
  <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center gap-12 lg:gap-20 px-6">
    ...
    <div className="relative w-full max-w-[420px] aspect-square">
      ...
      {/* Experience Badge */}
      <div className="absolute -right-6 md:-right-10 top-12 md:top-20 w-[110px] h-[110px] md:w-[150px] md:h-[150px] bg-gray-100 rounded-full flex flex-col items-center justify-center shadow">
